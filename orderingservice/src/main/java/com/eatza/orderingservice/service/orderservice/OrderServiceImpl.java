...
import com.eatza.orderingservice.dto.DeliveryRequestDto;
import com.eatza.orderingservice.dto.ItemFetchDto;
...
import com.eatza.orderingservice.repository.OrderRepository;
import com.eatza.orderingservice.service.itemservice.ItemService;
...
public class OrderServiceImpl implements OrderService {
  ...
  private static final String DELIVERY_TOPIC = "deliveryTopic";
	...
	public Order placeOrder(OrderRequestDto orderRequest) throws OrderException {
		...
		kafkaTemplate.send(DELIVERY_TOPIC,new DeliveryRequestDto(savedOrder.getCustomerId(),savedOrder.getRestaurantId(),savedOrder.getStatus()));
		return savedOrder;
	}
